...
From the above plot, we can see that the columns was ordered in character order. I would like to reorder the `height_range_id` in numeric order to make it looks more clear.
