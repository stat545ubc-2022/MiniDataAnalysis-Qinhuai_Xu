...
Based on the longitude and latitude, I visualize the trees' map for the 5 most popular genus trees. Because there are lots of overlapping between these points, I applied alpha transparency to make them clear. I noticed that some genus of tree distributions are quite dispersed that it is difficult (or meaningless) to find the clusters of them. 
