...
To be mentioned that some genus of tree distributions are quite dispersed that it is difficult (or meaningless) to find the clusters of them. Therefore, I would like to apply clustering algorithms only on particular tree genus with obvious clusters.
